<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:59:"D:\WWW\ZQ\public/../application/admin\view\index\index.html";i:1534315421;s:49:"D:\WWW\ZQ\application\admin\view\Public\left.html";i:1535078791;}*/ ?>
<!DOCTYPE html>
<html>
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                ...
                                <li class="divider"></li>
                                <li><a href="<?php echo url('base/logout'); ?>">安全退出</a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li><a class="J_menuItem" href="<?php echo url('staff_data/index'); ?>">Bootstrap Table
            ...
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        ...
                        <li class="hidden-xs">
                            <a href="<?php echo url('StaffData/add_profile'); ?>" class="J_menuItem" data-index="0"><i class="fa fa-cloud"></i> 完善资料</a>
                        </li>
